...
class sub_convert:
    ...
    def makeup(
        input, dup_rm_enabled=False, format_name_enabled=True, speedtest=False
        ...
        for line in lines:
            ...
            if 'ssr://' in line:
                try:
                    ...
                    yaml_url.setdefault(
                        'obfs-param', sub_convert.base64_decode(param_dic['obfsparam'])
                    )
                    yaml_url.setdefault(
                        'protocol-param',
        ...
        try:
            ...
            for index in range(
                ...
                if (
                    ...
                    ssr_proxy = str(
                        'ssr://' + sub_convert.base64_encode(ssr_base64_decoded) + '\n'
                    )
    ...
    def convert_remote(
        url='', output_type='clash', host='https://subsc.ednovas.xyz'
